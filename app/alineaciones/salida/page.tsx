...
const FFLineupAbi = [
	{ type: "function", name: "removeFromLineup", stateMutability: "nonpayable", inputs: [
...
export default function Page() {
	...
	return (
		<main className="space-y-4">
			<h1 className="text-2xl font-bold">Registrar salida de jugador</h1>
			<form
				onSubmit={(e) => {
					e.preventDefault();
					writeContract({ address: CONTRACTS.FFLineup as `0x${string}`, abi: FFLineupAbi, functionName: "removeFromLineup", args: [BigInt(gameId || "0"), BigInt(clubId || "0"), BigInt(playerId || "0")] });
				}}
