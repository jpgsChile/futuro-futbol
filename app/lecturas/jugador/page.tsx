				...
				return (
					<DetailList
						items={[
							...
							{ label: "Posición secundaria", value: POSITIONS[Number(p.secondaryPosition ?? 0)] ?? p.secondaryPosition },
							{ label: "Posición terciaria", value: POSITIONS[Number(p.tertiaryPosition ?? 0)] ?? p.tertiaryPosition },
